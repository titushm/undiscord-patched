...
<!-- Download links -->
  [greasyfork_url]: <https://greasyfork.org/en/scripts/469310-undiscord-patched> "Get Undiscord from GreasyFork"
  [openuserjs_url]: <https://greasyfork.org/en/scripts/469310-undiscord-patched> "Get Undiscord from OpenUserJS"
